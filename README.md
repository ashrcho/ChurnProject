...
I chose to use Median because the features are not normally distributed. Outliers might give us unrepresentative verages that would affect our interpretation. 
