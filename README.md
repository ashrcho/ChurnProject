...
I chose to use Median because the features are not normally distributed. Outliers might give us incorrect averages that would affect our interpretation. 
